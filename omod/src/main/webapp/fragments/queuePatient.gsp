...
//                    jq("#divForpassportNumber").html(data);
    ...
    function goto_previous_tab(current_tab) {
     ...
     function showTab(tabId) {
         const tabs = document.querySelectorAll('.ke-tab-content');
         tabs.forEach(tab => {
             if (tab.id === tabId) {
...
.ke-tab {
    /* Add individual tab styles here */
    display: inline-block;
    padding: 10px 20px;
    cursor: pointer;
}
...
.ke-tab-content {
    /* Add tab content styles here */
    display: none;
    /* You may want to add additional styles like padding, border, etc. */
}
</style>
<div id="content" class="container">
    <div class="ke-tab-container">
        ...
        <div id="NewPatient" class="ke-tab-content">
        ...
        <div id="RevisitPatient" class="ke-tab-content">
%{--            Code for Revisit Patient--}%
        </div>
    </div>
